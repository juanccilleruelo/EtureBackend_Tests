...
{$M+}
   [TestFixture]
   TTestParticipants = class(TObject)
   private
   published
...
[Test] [async] procedure TTestParticipants.TestGetValues;
...
initialization
   TTMSWEBUnitTestingRunner.RegisterClass(TTestParticipants);
end.
